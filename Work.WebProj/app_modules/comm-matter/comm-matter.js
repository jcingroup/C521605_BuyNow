    ...
    MatterList.prototype.render = function () {
        ...
        outHtml = (React.createElement("div", {className: "wrap"}, ele_search_form, React.createElement("p", {className: "clearfix"}, React.createElement("span", {className: "result pull-xs-left"}, "共有", React.createElement("strong", {className: "text-danger"}, this.state.lists.length), "間房屋符合條件"), React.createElement("span", {className: "pull-xs-right form-inline"}, React.createElement("label", {htmlFor: ""}, "排序方式："), React.createElement("select", {className: "form-control form-control-sm"}, React.createElement("option", {value: true}, "預設排序"), React.createElement("option", {value: true}, "更新時間新 → 舊"), React.createElement("option", {value: true}, "總價低 → 高"), React.createElement("option", {value: true}, "總價高 → 低"), React.createElement("option", {value: true}, "坪數低 → 高"), React.createElement("option", {value: true}, "坪數高 → 低"), React.createElement("option", {value: true}, "屋齡低 → 高"), React.createElement("option", {value: true}, "屋齡高 → 低")))), React.createElement("ol", {className: "prolist row"}, this.state.lists.map(function (item, i) {
            ...
            if (_this.props.info_type == 'S') {
                ...
                out_html = React.createElement("li", {className: "pro", key: item.matter_id}, React.createElement("article", {className: "card"}, React.createElement("a", {className: "card-img-top", href: link_content + item.matter_id}, React.createElement("img", {alt: item.matter_name, src: item.list_src})), React.createElement("div", {className: "card-block"}, React.createElement("h4", {className: "card-title"}, React.createElement("a", {href: link_content + item.matter_id}, item.matter_name)), React.createElement("section", {className: "card-text"}, React.createElement("h5", {className: "card-subtitle"}, item.title), React.createElement("ul", {className: "feature list-inline"}, React.createElement("li", null, item.city + item.country + item.address)), React.createElement("ul", {className: "info list-inline"}, React.createElement("li", null, item.build_area, " ", React.createElement("span", {className: "text-muted"}, "建坪")), React.createElement("li", null, item.house_area + item.balcony_area, " ", React.createElement("span", {className: "text-muted"}, "主+陽")), React.createElement("li", null, item.age, " ", React.createElement("span", {className: "text-muted"}, "年")), React.createElement("li", null, "14/16 ", React.createElement("span", {className: "text-muted"}, "樓")), React.createElement("li", null, item.bedrooms, " ", React.createElement("span", {className: "text-muted"}, "房"), item.livingrooms, " ", React.createElement("span", {className: "text-muted"}, "廳"), item.bathrooms, " ", React.createElement("span", {className: "text-muted"}, "衛"), item.rooms, " ", React.createElement("span", {className: "text-muted"}, "室"))), React.createElement("span", {className: "price"}, React.createElement("strong", {className: "text-danger"}, item.price / 10000), "萬")), React.createElement("a", {className: "more btn btn-secondary", href: link_content + item.matter_id}, "看更多", React.createElement("i", {className: "ti-angle-right"})))));
            }
            if (_this.props.info_type == 'R') {
                var link_content = _this.props.community_id == null ? gb_approot + 'Rent/Content?id=' : 'Rent_content?id=';
                out_html = React.createElement("li", {className: "pro"}, React.createElement("article", {className: "card"}, React.createElement("a", {className: "card-img-top", href: link_content + item.matter_id}, React.createElement("img", {alt: item.matter_name, src: item.list_src})), React.createElement("div", {className: "card-block"}, React.createElement("h4", {className: "card-title"}, React.createElement("a", {href: link_content + item.matter_id}, item.matter_name)), React.createElement("section", {className: "card-text"}, React.createElement("h5", {className: "card-subtitle"}, item.title), React.createElement("ul", {className: "feature list-inline"}, React.createElement("li", null, item.city + item.country + item.address)), React.createElement("ul", {className: "info list-inline"}, React.createElement("li", null, item.build_area, " ", React.createElement("span", {className: "text-muted"}, "坪")), React.createElement("li", null, "14/16 ", React.createElement("span", {className: "text-muted"}, "樓")), React.createElement("li", null, item.bedrooms, " ", React.createElement("span", {className: "text-muted"}, "房"), item.livingrooms, " ", React.createElement("span", {className: "text-muted"}, "廳"), item.bathrooms, " ", React.createElement("span", {className: "text-muted"}, "衛"), item.rooms, " ", React.createElement("span", {className: "text-muted"}, "室"))), React.createElement("span", {className: "price"}, React.createElement("strong", {className: "text-danger"}, CommFunc.formatNumber(item.rentOfMonh)), "元/月")), React.createElement("a", {href: link_content + item.matter_id, className: "more btn btn-secondary"}, "看更多", React.createElement("i", {className: "ti-angle-right"})))));
            }
            return out_html;
        }))));
        return outHtml;
