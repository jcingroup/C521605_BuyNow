...
/***/ function(module, exports, __webpack_require__) {
	...
	var MasterImageUpload = (function (_super) {
	    ...
	    MasterImageUpload.prototype.render = function () {
	        var outHtml = null;
	        outHtml = (React.createElement("div", null, React.createElement("div", {className: "form-control"}, React.createElement("input", {type: "file", id: 'upload-btn-' + this.props.MainId + '-' + this.props.FileKind, accept: "image/*"})), React.createElement("ol", {className: "upload-img list-inline m-b-0", ref: this.sortableGroupDecorator}, this.state.filelist.map(function (itemData, i) {
	            var subOutHtml = React.createElement("li", {className: "list-inline-item", key: itemData.guid}, React.createElement("button", {type: "button", className: "close", onClick: this.deleteFile.bind(this, itemData.guid), title: "刪除圖片"}, " × "), React.createElement("img", {src: itemData.iconPath, title: CommFunc.formatFileSize(itemData.size)}));
	            return subOutHtml;
