...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tips = (function (_super) {
	    ...
	    Tips.prototype.render = function () {
	        ...
	        var out_html = null;
	        out_html = (React.createElement(OverlayTrigger, {placement: "top", overlay: tooltipObj}, React.createElement("span", {className: "label label-circle label-info"}, "?")));
	        return out_html;
	    };
	    return Tips;
	}(React.Component));
	...
	var MasterImageUpload = (function (_super) {
	    ...
	    MasterImageUpload.prototype.render = function () {
	        var outHtml = null;
	        outHtml = (React.createElement("div", null, React.createElement("div", {className: "form-control"}, React.createElement("input", {type: "file", id: 'upload-btn-' + this.props.MainId + '-' + this.props.FileKind, accept: "image/*"})), React.createElement("ol", {className: "upload-img list-inline", ref: this.sortableGroupDecorator}, this.state.filelist.map(function (itemData, i) {
