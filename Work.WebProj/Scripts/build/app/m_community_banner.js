	...
	var GridNavPage = (function (_super) {
	    ...
	    GridNavPage.prototype.render = function () {
	        ...
	        if (this.props.showAdd) {
	            setAddButton = React.createElement("button", {className: "btn-success", type: "button", onClick: this.props.insertType}, React.createElement("i", {className: "fa-plus-circle"}), " 新增");
	        }
